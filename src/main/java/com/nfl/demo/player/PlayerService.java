...
public class PlayerService {
    ...
    public List<Player> getPlayersByName(String searchText){
        return playerRepository.findAll().stream()
                .filter(player -> player.getFirstName().toLowerCase().contains(searchText.toLowerCase()))
                .collect(Collectors.toList());
    }
    ...
    public List<Player> getPlayerByLastName(String searchText){
        return playerRepository.findAll().stream()
                .filter(player -> player.equals(player.getLastName().toLowerCase().contains(searchText.toLowerCase())))
                .collect(Collectors.toList());
    }
    ...
    public Player updatePlayer(Player updatedPlayer) {
        Optional<Player> existingPlayer = playerRepository.findByName(updatedPlayer.getFirstName());
